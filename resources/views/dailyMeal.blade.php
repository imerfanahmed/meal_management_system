...
<div class="app-content content ">
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12">
                <h1>Current Month : {{Carbon::now()->toFormattedDateString()}}</h1>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-switch custom-switch-success">
                                            <input type="checkbox" checked class="custom-control-input" id="{{$loop->index}}" />
                                            <label class="custom-control-label"for="{{$loop->index}}" >
